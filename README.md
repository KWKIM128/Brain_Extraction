RGU-Net is a lightweight U-Net based model developed for automated brain extraction. The model implements the Ghost and Residual modules to produce 2D segmentation at a lower computational cost. 
